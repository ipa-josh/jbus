...
#if (SOFTUART_TIMERTOP > 0xff || SOFTUART_TIMERTOP<10)
...
inline void softuart_enable() {}
inline void softuart_disable() {}
inline void softuart_putchar( const char c) {}
inline void softuart_init(void) {}
inline unsigned char softuart_kbhit( void ) {return 0;}
