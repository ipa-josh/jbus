gl_vis_temp['light'] = {
	init: function($this) {
		$this.append('<img id="on" style="display:inline;position:absolute" src="'+$this.data("vis").img.on+'" />')
		$this.append('<img id="off" style="display:inline;position:absolute" src="'+$this.data("vis").img.off+'" />')
